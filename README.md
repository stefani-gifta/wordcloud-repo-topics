<div align="center">
  ...
  A GitHub Action that reads all your repository topics—from both public and private repositories—via the GitHub GraphQL API and generates a word cloud SVG.
